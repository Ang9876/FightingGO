...
void Shader::setMat4fv(const std::string &name, int num, int transpose, const GLfloat* trans) const
{
    glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), num, transpose, trans);
}